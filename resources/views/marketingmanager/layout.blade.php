    ...
    <ul class="navbar-nav ml-auto">
     <li class="nav-item dropdown dropdown-hover">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow" style="left:auto; right:10px;">
              <li><a href="{{url('employee/marketingmanager/profile')}}" class="dropdown-item">Change Password </a></li>
              <li><a href="{{url('employee/marketingmanager/logout')}}" class="dropdown-item">Logout</a></li>
            </ul>
          </li>     
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:rgba(116, 52, 16, 1);">
   ...
   <a href="#" class="brand-link">
     <img src='{{asset("assets/images/clg.png")}}' alt="John Doe" alt="AdminLTE Logo"  style="width:40px;height:40px" />
      <span class="brand-text font-weight-dark" style="color:white;"><?Php echo session()->get('MARKETINGMANAGER_fname'); ?></span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column"data-widget="treeview"role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a  href="{{url('employee/marketingmanager/dashboard')}}" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>Dashboard</p>
            </a>
          </li>
          <li class="nav-item">
            <a  href="{{url('employee/marketingmanager/marketingofficers')}}" class="nav-link">
