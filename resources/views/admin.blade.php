      ...
      <div class="video-overlay header-text">
          <div class="caption">
              ...
              <div class="main-button">
                  <div class="">
                  <a href="{{url('nontech/groupmanager/login')}}">GROUP MANAGER LOGIN</a>
                  <a href="{{url('nontech/manager/login')}}">MANAGER LOGIN</a>    
                  <a href="{{url('nontech/staff/login')}}">STAFF LOGIN</a>
                  <a href="{{url('vendor/caterer/login')}}">VENDOR LOGIN</a>
                  </div>
              </div>
          </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <!-- Do you need a working HTML contact-form script?
          ...
          <form id="contact" action="{{url('admin/contact')}}" method="post">
            @csrf
            <div class="row">
              <div class="col-md-6">
                  <fieldset>
