    ...
    <section class="section features" id="section1">
        <div class="px-4 py-16 mx-auto w-full md:px-24 lg:px-8 lg:py-20">
            <div class="mainhead max-w-2xl mb-10 sm:text-center">
                <h2
                    class="max-w-2xl mx-auto mb-6 font-sans text-4xl font-bold leading-none tracking-tight text-white sm:text-5xl md:mx-auto">
                    {{-- <h2
                        ...
                        <div class="card-no-hover">
                            <div class="content">
                                <a href="{{ $list->awebsitelink }}">
                                    <img src="{{ asset('adminimages') }}/{{ $list->image }}" alt="University Images"
                                        class="img-fluid">
            ...
            <div class="row">
                ...
                <form class="footer_form flex flex-col mt-4 md:flex-row" id="contact"
                    ...
                    <div class="row" style="position: relative">
                        ...
                        <div class="col-md-6 col-sm-12" style="margin-bottom: 15px">
                            <fieldset>
                                <select name="school_name" class="form-control" id="school_dropdown" required>
                                    <option value="" disabled selected>Select Your School</option>
                                    @foreach ($schools->map(function($item) {
                                        $item->aname = ucwords(strtolower($item->aname)); // Capitalize first letter of each word
                                        return $item;
                                    })->unique('aname') as $list)
                                        <option value="{{ $list->aname }}">{{ $list->aname }}</option>
                                    @endforeach
                                    <option value="Others">Others</option>
                                </select>
                            </fieldset>
                        </div>
                        <div class="col-md-12 col-sm-12" style="margin-bottom: 15px; display: none;" id="other_school_field">
                            <fieldset>
                                <input name="other_school_name" type="text" class="form-control" id="other_school_name"
                                    placeholder="Enter Your School Name">
                            </fieldset>
                        </div>
                        <div class="col-md-12" style="margin-bottom: 15px">
                            <fieldset>
                                <textarea name="message" rows="6" class="form-control" id="message" placeholder="Your issues..."
                                    required=""></textarea>
                            </fieldset>
                        </div>
