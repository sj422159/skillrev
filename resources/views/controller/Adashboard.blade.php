    ...
    <div class="row col-12">
        <div class="card card-widget widget-user" style="width:300px;height: 280px;margin:0px 20px 0px 15px;">
            ...
            <div class="card-footer" style="background-color: #fff;">
                <div class="row col-12"
                    ...
                    <a href="{{url('admin/adddetails')}}" class="btn btn-block btn-primary btn-sm col-6"
                        style="background-image: linear-gradient(to right,#5235ba,#7e3ded);">
        ...
        <div class="col-lg-4 col-8">
            <div class="small-box bg-info" style="background-image: linear-gradient(to right,darkblue,blue);">
                ...
                <a href="{{ url('admin/studentdetails') }}" class="small-box-footer">More Details<i
            ...
            <div class="small-box bg-info" style="background-image: linear-gradient(to right,darkblue,blue);">
                ...
                <a href="{{ url('admin/approve/leave') }}" class="small-box-footer">More Details<i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-8">
            <div class="small-box bg-info" style="background-image: linear-gradient(to right,darkgreen,lightgreen);">
                ...
                <a href="{{url('admin/assesments')}}" class="small-box-footer">More Details<i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
            <div class="small-box bg-info" style="background-image: linear-gradient(to right,darkgreen,lightgreen);">
                <div class="inner">
                ...
                <a href="{{url('admin/questions')}}" class="small-box-footer">More Details<i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-4 col-8">
            <div class="small-box bg-danger" style="background-image:linear-gradient(to right,#2193b0,#6dd5ed);">
                ...
                <a href="{{url('admin/assigned')}}/" class="small-box-footer">More Details<i
                        class="fas fa-arrow-circle-right"></i></a>
            </div>
