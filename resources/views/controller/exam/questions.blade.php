@extends('controller/exam/elayout')
...
@if(session()->has('success'))
    ...
    @endif
<form action="{{url('exam_controller/questions/bysa')}}" method="post">
    @csrf
    <div class="form-row">
...
<div class="card">
    <div class="card-header">
        <a href="{{url('exam_controller/questions/add')}}">
    ...
    <!-- /.card-header -->
      ...
      <thead>
         ...
         <td>
            <a href="{{url('exam_controller/question/edit')}}/{{$list->id}}"><button type="button" class="btn btn-success btn-sm">Edit</button>
            </a>

             <a href="{{url('exam_controller/question/delete')}}/{{$list->id}}"><button type="button" class="btn btn-danger btn-sm">Delete</button>
             </a>
              <a href="{{url('exam_controller/question/view')}}/{{$list->id}}"><button type="button" class="btn btn-secondary btn-sm">View</button>
             </a>
            </td>
          </tr>
          @endforeach
...
jQuery(document).ready(function(){
           ...
           jQuery('#mainbranch').change(function (){
             ...
             jQuery.ajax({
              url:'{{url("exam_controller/questionbank/getdomain")}}',
              type:'get',
              data:'cid='+cid+
              '&_token={{csrf_token()}}',
            ...
            var sid=jQuery(this).val();
             jQuery.ajax({
              url:'{{url("exam_controller/questionbank/getskillset")}}',
              type:'post',
              data:'sid='+sid+
              '&_token={{csrf_token()}}',
              success:function(result){
            ...
            var gid=jQuery(this).val();
             jQuery.ajax({
              url:'{{url("exam_controller/questionbank/getskillattribute")}}',
              type:'post',
              data:'gid='+gid+
              '&_token={{csrf_token()}}',
              success:function(result){
 ...
 $(document).ready(function(){
           ...
           $('#subbranch').html('');
            $.ajax({
              url:'{{url("exam_controller/skillattribute/domain/{id}")}}',
              type:'GET',
              data:{myID:state},
              dataType: "json",
         ...
         function subskillset(){
           ...
           $('#subskillset').html('');
            $.ajax({
              url:'{{url("exam_controller/skillattribute/skillset/{id}")}}',
              type:'GET',
              data:{id:state},
              dataType: "json",
              success:function(data)
        ...
        function skillattribute(){
           ...
           $('#skillattribute').html('');
            $.ajax({
              url:'{{url("exam_controller/skillattribute/getskillattribute/{id}")}}',
              type:'GET',
              data:{id:state},
              dataType: "json",
              success:function(data)
