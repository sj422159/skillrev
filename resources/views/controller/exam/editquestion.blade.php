...
<div class="col-10" style="margin:50px !important">
   <a href="{{url('exam_controller/questions')}}"><button type="submit" class="btn btn-danger" style="margin-bottom:15px !important;">Back</button></a>
 <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{url('exam_controller/question/update')}}" method="post" enctype="multipart/form-data">
              	@csrf
                <div class="card-body">
