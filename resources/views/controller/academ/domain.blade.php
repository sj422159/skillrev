...
<form action="{{url('academic_controller/domain/bycategory')}}" method="post">
    @csrf
    <div class="form-row">
        ...
        <div class="col-12 col-sm-3 mt-4 mt-sm-0">
            <label></label><br>
           <a href="{{url('academic_controller/domain/adddomain')}}">
            ...
            <table class="table table-borderless table-data3">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$list->domain}}</td>
                        <td>
                            <a href="{{url('academic_controller/domain/adddomain')}}/{{$list->id}}"><button type="button" class="btn btn-success">Edit</button>
                            </a>
                            <a href="{{url('academic_controller/domain')}}/{{$list->id}}"><button type="button" class="btn btn-danger">Delete</button>
                            </a>
                        </td>
                    </tr>
                    @endforeach
