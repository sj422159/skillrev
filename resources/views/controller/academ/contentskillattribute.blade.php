...
@endif
<form action="{{url('academic_controller/content/skillattribute/byskillset')}}" method="post">
    @csrf
    <div class="form-row">
        ...
        <div class="col-12 col-sm-3 mt-4 mt-sm-0">
           ...
           <a href="{{url('academic_controller/content/skillattribute/addskillattribute')}}">
            ...
            <table class="table table-borderless table-data3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{url('academic_controller/content/skillattribute/addskillattribute')}}/{{$list->id}}"><button type="button" class="btn btn-success">Edit</button>
                            </a>
                            <a href="{{url('academic_controller/content/skillattribute')}}/{{$list->id}}"><button type="button" class="btn btn-danger">Delete</button>
                            </a>
                        </td>
                    </tr>
                    @endforeach
...
jQuery(document).ready(function(){
           ...
           jQuery('#category').change(function (){
             ...
             jQuery.ajax({
              url:'{{url("academic_controller/questionbank/getdomain")}}',
              type:'get',
              data:'cid='+cid+
              '&_token={{csrf_token()}}',
