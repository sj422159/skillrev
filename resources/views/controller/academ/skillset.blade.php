...
<form action="{{url('academic_controller/skillset/bydomain')}}" method="post">
    @csrf
    <div class="form-row">
        ...
        <div class="col-12 col-sm-3 mt-4 mt-sm-0">
            <label></label><br>
             <a href="{{url('academic_controller/skillset/addskillset')}}">
            ...
            <table class="table table-borderless table-data3">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$list->skillset}}</td>
                        <td>
                            <a href="{{url('academic_controller/skillset/addskillset')}}/{{$list->id}}"><button type="button" class="btn btn-success">Edit</button>
                            </a>
                            <a href="{{url('academic_controller/skillset')}}/{{$list->id}}"><button type="button" class="btn btn-danger">Delete</button>
                            </a>
                        </td>
                    </tr>
                    @endforeach
