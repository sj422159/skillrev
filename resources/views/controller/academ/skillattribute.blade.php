...
<form action="{{url('academic_controller/skillattribute/byskillset')}}" method="post">
    @csrf
    <div class="form-row">
        ...
        <div class="col-12 col-sm-3 mt-4 mt-sm-0">
            <label></label><br>
           <a href="{{url('academic_controller/skillattribute/addskillattribute')}}">
            ...
            <table class="table table-borderless table-data3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{url('academic_controller/skillattribute/addskillattribute')}}/{{$list->id}}"><button type="button" class="btn btn-success">Edit</button>
                            </a>
                            <a href="{{url('academic_controller/skillattribute')}}/{{$list->id}}"><button type="button" class="btn btn-danger">Delete</button>
                            </a>
                        </td>
                    </tr>
                    @endforeach
...
jQuery(document).ready(function(){
          ...
          jQuery('#group').change(function (){
             ...
             jQuery.ajax({
              url:'{{url("academic_controller/questionbank/getcategory")}}',
              type:'get',
              data:'cid='+cid+
              '&_token={{csrf_token()}}',
           ...
           jQuery('#category').change(function (){
             ...
             jQuery.ajax({
              url:'{{url("academic_controller/getdomains")}}',
              type:'get',
            ...
            var sid=jQuery(this).val();
             jQuery.ajax({
              url:'{{url("academic_controller/questionbank/getskillset")}}',
              type:'post',
              data:'sid='+sid+
              '&_token={{csrf_token()}}',
              success:function(result){
        ...
        function skillattribute(){
            ...
            $('#skillset').html('');
            $.ajax({
              url:'{{url("academic_controller/skillset/getskillset/{id}")}}',
              type:'GET',
              data:{id:state},
              dataType: "json",
              success:function(data)
