...
<div class="row">
    <div class="col-9">
        <div class="card card-primary">
            ...
            <form action="{{url('academic_controller/content/skillattribute/saveskillattribute')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                <div class="form-row">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{url('academic_controller/content/skillattribute')}}" class="btn btn-danger">Back</a>
                </div>
        </div>
        </form>
    </div>
...
<script type="text/javascript">
        ...
        $(document).ready(function(){
           ...
           $('#subbranch').html('');
            $.ajax({
              url:'{{url("academic_controller/skillattribute/domain/{id}")}}',
              type:'GET',
              data:{myID:state},
              dataType: "json",
         ...
         function subskillset(){
           ...
           $('#subskillset').html('');
            $.ajax({
              url:'{{url("academic_controller/skillattribute/skillset/{id}")}}',
              type:'GET',
              data:{id:state},
              dataType: "json",
              success:function(data)
        ...
        function skillattribute(){
           ...
           $('#skillattribute').html('');
            $.ajax({
              url:'{{url("academic_controller/skillattribute/getskillattribute/{id}")}}',
              type:'GET',
              data:{id:state},
              dataType: "json",
              success:function(data)
