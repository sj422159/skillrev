                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{url('Controller/Academ/dashboard')}}" class="nav-link" class="@yield('dashboard_select')">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    <a href="{{ route('controller.groups') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Group</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{url('controller/standard')}}" class="nav-link"
