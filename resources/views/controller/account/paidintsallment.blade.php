    ...
    <div class="row">
        <div class="col-12">
            <div class="card" style="margin-top:20px">
                ...
                <th>
                    <form  action="{{url('account/fees/students/save')}}" method="post" enctype="multipart/form-data">
                    @csrf 
                    <input type="hidden" name="studentid" value="{{$sid}}" />
                    <input type="hidden" name="feemonth" value="feeapr" />
                    <input type="hidden" name="fee" value="{{$apr}}" />
                ...
                @if($data[0]->feemay=="0" && $may!=0) 
                <th>
                    <form  action="{{url('account/fees/students/save')}}" method="post" enctype="multipart/form-data">
                    @csrf 
                    <input type="hidden" name="studentid" value="{{$sid}}" />
                    <input type="hidden" name="feemonth" value="feemay" />
                    <input type="hidden" name="fee" value="{{$may}}" />
                    <input type="file" name="file" required="true">
                    <button type="submit" class="btn btn-primary btn-sm mt-2">Save</button>
                    </form>
                </th>
                ...
                @if($data[0]->feejun=="0" && $jun!=0) 
                <th>
                    <form  action="{{url('account/fees/students/save')}}" method="post" enctype="multipart/form-data">
                    @csrf 
                    <input type="hidden" name="studentid" value="{{$sid}}" />
                    <input type="hidden" name="feemonth" value="feejun" />
                    <input type="hidden" name="fee" value="{{$jun}}" />
                    <input type="file" name="file" required="true">
                    <button type="submit" class="btn btn-primary btn-sm mt-2">Save</button>
                    </form>
                </th>
                ...
                @if($data[0]->feejul=="0" && $jul!=0) 
                <th>
                    <form  action="{{url('account/fees/students/save')}}" method="post" enctype="multipart/form-data">
                    @csrf 
                    <input type="hidden" name="studentid" value="{{$sid}}" />
                    <input type="hidden" name="feemonth" value="feejul" />
                    <input type="hidden" name="fee" value="{{$jul}}" />
                    <input type="file" name="file" required="true">
                    <button type="submit" class="btn btn-primary btn-sm mt-2">Save</button>
                    </form>
                </th>
                ...
                @if($data[0]->feeaug=="0" && $aug!=0) 
                <th>
                    <form  action="{{url('account/fees/students/save')}}" method="post" enctype="multipart/form-data">
                    @csrf 
                    <input type="hidden" name="studentid" value="{{$sid}}" />
                    <input type="hidden" name="feemonth" value="feeaug" />
                    <input type="hidden" name="fee" value="{{$aug}}" />
                    <input type="file" name="file" required="true">
                    <button type="submit" class="btn btn-primary btn-sm mt-2">Save</button>
                    </form>
                </th>
                ...
                @if($data[0]->feesep=="0" && $sep!=0) 
                <th>
                    <form  action="{{url('account/fees/students/save')}}" method="post" enctype="multipart/form-data">
                    @csrf 
                    <input type="hidden" name="studentid" value="{{$sid}}" />
                    <input type="hidden" name="feemonth" value="feesep" />
                    <input type="hidden" name="fee" value="{{$sep}}" />
                    <input type="file" name="file" required="true">
                    <button type="submit" class="btn btn-primary btn-sm mt-2">Save</button>
                    </form>
                </th>
                ...
                @if($data[0]->feeoct=="0" && $oct!=0) 
                <th>
                    <form  action="{{url('account/fees/students/save')}}" method="post" enctype="multipart/form-data">
                    @csrf 
                    <input type="hidden" name="studentid" value="{{$sid}}" />
                    <input type="hidden" name="feemonth" value="feeoct" />
                    <input type="hidden" name="fee" value="{{$oct}}" />
                    <input type="file" name="file" required="true">
                    <button type="submit" class="btn btn-primary btn-sm mt-2">Save</button>
                    </form>
                </th>
                ...
                @if($data[0]->feenov=="0" && $nov!=0) 
                <th>
                    <form  action="{{url('account/fees/students/save')}}" method="post" enctype="multipart/form-data">
                    @csrf 
                    <input type="hidden" name="studentid" value="{{$sid}}" />
                    <input type="hidden" name="feemonth" value="feenov" />
                    <input type="hidden" name="fee" value="{{$nov}}" />
                    <input type="file" name="file" required="true">
                    <button type="submit" class="btn btn-primary btn-sm mt-2">Save</button>
                    </form>
                </th>
                ...
                @if($data[0]->feedec=="0" && $dec!=0) 
                <th>
                    <form  action="{{url('account/fees/students/save')}}" method="post" enctype="multipart/form-data">
                    @csrf 
                    <input type="hidden" name="studentid" value="{{$sid}}" />
                    <input type="hidden" name="feemonth" value="feedec" />
                    <input type="hidden" name="fee" value="{{$dec}}" />
                    <input type="file" name="file" required="true">
                    <button type="submit" class="btn btn-primary btn-sm mt-2">Save</button>
                    </form>
                </th>
                ...
                @if($data[0]->feejan=="0" && $jan!=0) 
                <th>
                    <form  action="{{url('account/fees/students/save')}}" method="post" enctype="multipart/form-data">
                    @csrf 
                    <input type="hidden" name="studentid" value="{{$sid}}" />
                    <input type="hidden" name="feemonth" value="feejan" />
                    <input type="hidden" name="fee" value="{{$jan}}" />
                    <input type="file" name="file" required="true">
                    <button type="submit" class="btn btn-primary btn-sm mt-2">Save</button>
                    </form>
                </th>
                ...
                @if($data[0]->feefeb=="0" && $feb!=0) 
                <th>
                    <form  action="{{url('account/fees/students/save')}}" method="post" enctype="multipart/form-data">
                    @csrf 
                    <input type="hidden" name="studentid" value="{{$sid}}" />
                    <input type="hidden" name="feemonth" value="feefeb" />
                    <input type="hidden" name="fee" value="{{$feb}}" />
                    <input type="file" name="file" required="true">
                    <button type="submit" class="btn btn-primary btn-sm mt-2">Save</button>
                    </form>
                </th>
                ...
                @if($data[0]->feemar=="0" && $mar!=0) 
                <th>
                    <form  action="{{url('account/fees/students/save')}}" method="post" enctype="multipart/form-data">
                    @csrf 
                    <input type="hidden" name="studentid" value="{{$sid}}" />
                    <input type="hidden" name="feemonth" value="feemar" />
                    <input type="hidden" name="fee" value="{{$mar}}" />
                    <input type="file" name="file" required="true">
                    <button type="submit" class="btn btn-primary btn-sm mt-2">Save</button>
                    </form>
                </th>
