...
<a href="{{url('account/fees/addschedule')}}">
        ...
        <table id="example1" class="display nowrap" style="width:100%   ">
                ...
                @foreach($otherdata as $list)
                    <tr>
                        ...
                        <td>
                            <a href="{{url('account/fees/addschedule')}}/{{$list->id}}"><button type="button" class="btn btn-success">Edit</button>
                            </a>
                            <a href="{{url('account/fees/schedule/delete')}}/{{$list->id}}"><button type="button" class="btn btn-danger">Delete</button>
                            </a>
                        </td>
                    </tr>
                @endforeach
