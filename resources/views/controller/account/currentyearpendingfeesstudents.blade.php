...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{url('account/fees/pending/currentyear/students/bysection')}}" method="post">
    @csrf
    <div class="form-row">
            ...
            <div class="card" style="margin-top:20px">
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        @if(count($students)>0)
                        <form action="{{url('account/fees/pending/currentyear/students/export')}}" id="forma" method="post">
                        @csrf
