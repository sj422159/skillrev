...
<a href="{{url('account/fees/adddiscount')}}">
                ...
                <tbody>
                  @foreach($data as $list)
                    <tr>
                        ...
                        <td>
                            <a href="{{url('account/fees/adddiscount')}}/{{$list->id}}"><button type="button" class="btn btn-success">Edit</button>
                            </a>
                            <a href="{{url('account/fees/discount/delete')}}/{{$list->id}}"><button type="button" class="btn btn-danger">Delete</button>
                            </a>
                        </td>
                    </tr>
                @endforeach
