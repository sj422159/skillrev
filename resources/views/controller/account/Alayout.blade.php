        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:rgba(116, 52, 16, 1);">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{url('Controller/Account/dashboard')}}" class="nav-link" class="@yield('dashboard_select')">
                         ...
                         <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                ...
                                <li class="nav-item">
                                    <a href="{{url('account/fees/distance')}}" class="nav-link"
                                 ...
                                 <li class="nav-item">
                                    <a href="{{url('account/fees/category')}}" class="nav-link"
                                        class="@yield('Questions_select')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Fees Category
                              ...
                              <li class="nav-item">
                                    <a href="{{url('account/fees/schedule')}}" class="nav-link"
                                        class="@yield('Questions_select')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                               ...
                               <li class="nav-item">
                                    <a href="{{url('account/transport/fees/schedule/busroutes')}}" class="nav-link"
                                        class="@yield('Questions_select')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                             ...
                             <li class="nav-item">
                                    <a href="{{url('account/fees/discount')}}" class="nav-link" class="@yield('list')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Special Discount
                                        </p>
                      ...
                      <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                             ...
                             <li class="nav-item">
                                    <a href="{{url('account/fees/pending')}}" class="nav-link"
                                        class="@yield('Questions_select')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Last Year Pending
                                  ...
                                  <li class="nav-item">
                                    <a href="{{url('account/fees/pending/currentyear')}}" class="nav-link"
                                        class="@yield('Questions_select')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                         ...
                         <li class="nav-item">
                                    <a href="{{url('account/fees/index/students')}}" class="nav-link"
                                        class="@yield('Questions_select')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
           ...
           <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview" style="display: none;">
                            ...
                            <li class="nav-item">
                                <a href="{{url('account/analytics/pendingfees')}}" class="nav-link"
                                    class="@yield('Questions_select')">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>
                                        Pending Fees
                               ...
                               <li class="nav-item">
                                <a href="{{url('account/analytics/currentfees')}}" class="nav-link"
                                    class="@yield('Questions_select')">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>
                                        Current Year Payment
                        ...
                        <ul class="nav nav-treeview" style="display: none;">
                            ...
                            <li class="nav-item">
                                <a href="{{url('controller/expgrp')}}" class="nav-link"
                                    class="@yield('Questions_select')">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>
                                    Expenses Group
                    ...
                    <li class="nav-item">
                                <a href="{{url('controller/expcat')}}" class="nav-link"
                                    class="@yield('Questions_select')">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>
                                    Expenses Category
