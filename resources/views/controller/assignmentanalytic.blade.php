...
<form action="{{url('controller/analytics/assignment/fetch')}}" method="post">
    @csrf
    <div class="form-row">
...
function  reload(that) {
    ...
    if(type==1){
        ...
        $.ajax({
              url:'{{url("controller/analytic/assignment/notcompleted")}}',
              type:'GET',
        ...
        $.ajax({
              url:'{{url("controller/analytic/assignment/completed")}}',
              type:'GET',
              data:{assignment:assignment},
              dataType: "json",
              success:function(sdata){
...
<script type="text/javascript">
  ...
  function sec(that){
          ...
          var sectionid=$('#clas').attr('data-val');
           ...
           $('#section').html('');
            $.ajax({
              url:'{{url("controller/classby/section/{id}")}}',
              type:'GET',
              data:{id:classid},
              dataType: "json",
         ...
         function gettrain(that){
          ...
          var trainid=$('#section').attr('data-sec');
           ...
           $('#train').html('');
            $.ajax({
              url:'{{url("controller/trainings/get")}}',
              type:'GET',
