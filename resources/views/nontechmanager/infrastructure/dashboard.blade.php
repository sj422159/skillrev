    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-8">
            ...
            <div class="small-box bg-info" style="background-image: linear-gradient(to right,darkblue,blue);">
                <div class="inner">
                    <h3 style="color: #fff" id="profiles">{{$groups[0]->count}}</h3>
                    <p>{{$groups[0]->infragroup}}</p>
                </div>
                <div class="icon">
        ...
        <div class="col-lg-4 col-8">
            ...
            <div class="small-box bg-info" style="background-image: linear-gradient(to right,darkblue,blue);">
                <div class="inner">
                    <h3 style="color: #fff" id="profiles">{{$groups[2]->count}}</h3>
                    <p>{{$groups[2]->infragroup}}</p>
                </div>
                <div class="icon">
                    <i class="ion ion-stats-bars"></i>
                </div>                
            ...
            <div class="small-box bg-info" style="background-image: linear-gradient(to right,darkblue,blue);">
                <div class="inner">
                    <h3 style="color: #fff" id="profiles">{{$groups[3]->count}}</h3>
                    <p>{{$groups[3]->infragroup}}</p>
                </div>
                <div class="icon">
                    <i class="ion ion-stats-bars"></i>
                </div>                
