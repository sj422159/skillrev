...
<style type="text/css">
 ...
 <div class="row" >
    ...
    <div class="card-header d-flex p-0">
                <h3 class="card-title p-3">School Repairs</h3>
                 
                <ul class="nav nav-pills ml-auto p-2">
                  <!-- <li class="nav-item"><a class="nav-link active" href="#tab_1" data-toggle="tab">Hostel</a></li> -->
                  <li class="nav-item"><a class="nav-link active" href="#tab_2" data-toggle="tab">School</a></li>
      ...
      <!--   <table id="example1" class="display nowrap" style="width:100%   ">
        ...
        <table id="example2" class="display nowrap" style="width:100%   ">
                ...
                <tbody>
                  ...
                  <td>
                    @if($list->repair==1)
                    <a href="{{url('nontech/manager/infrastructure/school/repair/start')}}/{{$list->id}}" class="btn btn-primary btn-sm">start</a>
                    @else
