...
<div class="row">
    <div class="col-12">
        <div class="card card-primary">
            ...
            <form action="{{url('nontech/manager/infrastructure/hostel/item/savedata')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
        ...
        <div class="col-12 col-sm-6 mt-4 mt-sm-0">
            <label>Room</label>
            <select class="form-control" id="domain" aria-required="true"aria-invalid="false"name="roomno" data-val="{{$data[0]->hostelid}}"  data-room="{{$data[0]->roomid}}">
                <option value="">Select</option>
            </select>
        </div>
        </div>
