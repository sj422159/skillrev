                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{url('nontech/manager/dashboard')}}" class="nav-link"
                                class="@yield('dashboard_select')">
                        ...
                        $groups =
                        DB::table('infragroups')->where('aid',session()->get('NONTECH_MANAGER_ADMIN_ID'))->get();
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                ...
                                <li class="nav-item menu">
                                    <a href="{{url('nontech/manager/infrastructure/work')}}/{{$list->id}}"
                                        class="nav-link">
               ...
               Infrastructure Items
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                @foreach($groups as $list)
                                <li class="nav-item menu">
                                    <a href="{{url('nontech/manager/infrastructure/repairs')}}/{{$list->id}}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            {{$list->infragroup}}
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    <a href="{{url('nontech/manager/infrastructure/reports/repairs/1')}}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>School Repairs</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{url('nontech/manager/infrastructure/reports/repairs/2')}}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Hostel Repairs</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{url('nontech/manager/infrastructure/reports/repairs/3')}}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                ...
                                <li class="nav-item">
                                    <a href="{{url('nontech/manager/infrastructure/reports/repairs/4')}}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Others Repairs</p>
                                    </a>
