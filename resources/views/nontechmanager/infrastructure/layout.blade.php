      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown dropdown-hover">
          ...
          <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow" style="left:auto; right:10px;">
            <li><a href="{{url('nontech/manager/profile')}}" class="dropdown-item">Change Password </a></li>
            <li><a href="{{url('nontech/manager/logout')}}" class="dropdown-item">Logout</a></li>
          </ul>
        </li>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item menu-open">
              <a href="{{url('nontech/manager/dashboard')}}" class="nav-link" class="@yield('dashboard_select')">
            ...
            $groups = DB::table('infragroups')->where('aid',session()->get('NONTECH_MANAGER_ADMIN_ID'))->get();
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview" style="display: none;">
                ...
                <li class="nav-item menu">
                  <a href="{{url('nontech/manager/infrastructure/work')}}/{{$list->id}}" class="nav-link">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview" style="display: none;">
                <li class="nav-item menu">
                  <a href="{{url('nontech/manager/infrastructure/additional')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>
                      Hostel
                    </p>
            ...
            <!--  <li class="nav-item menu">
            <a  href="{{url('nontech/manager/infrastructure/items')}}" class="nav-link" >
              <i class="nav-icon fas fa-bookmark"></i>
              <p>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview" style="display: none;">
                @foreach($groups as $list)
                <li class="nav-item menu">
                  <a href="{{url('nontech/manager/infrastructure/repairs')}}/{{$list->id}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>
                      {{$list->infragroup}}
                    </p>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview" style="display: none;">
                <li class="nav-item">
                  <a href="{{url('nontech/manager/infrastructure/reports/repairs/1')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>School Repairs</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{url('nontech/manager/infrastructure/reports/repairs/2')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Hostel Repairs</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{url('nontech/manager/infrastructure/reports/repairs/3')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Cafeteria Repairs</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{url('nontech/manager/infrastructure/reports/repairs/4')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Others Repairs</p>
                  </a>
                </li>
