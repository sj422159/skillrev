...
@section('title','Add Others Items')
...
<div class="row">
        ...
        <form action="{{url('nontech/manager/infrastructure/other/uploaditems')}}" enctype="multipart/form-data" method="post" class="col-12"> @csrf
               
            <div class="form-row mt-4">
            
      <div class="col-12 col-sm-4 mt-4 mt-sm-0">
            <label>Rooms</label>
            <select class="form-control" aria-required="true" aria-invalid="false" name="roomno" id="category">
