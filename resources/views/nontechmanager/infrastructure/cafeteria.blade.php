...
@if(session()->has('success'))
    ...
    @endif
<form action="{{url('nontech/manager/infrastructure/cafeteria/info/byfilter')}}" method="post">
    @csrf
    <div class="form-row">
        ...
        <div class="col-12 col-sm-3 mt-4 mt-sm-0">
            ...
            @if(count($data)>0)
            <a href="{{url('nontech/manager/infrastructure/cafeteria/info/export')}}/{{$mid}}"><button type="button"class="btn btn-success">Export</button></a>
            @else
...
<div class="card">
    <div class="card-header">
        <a href="{{url('nontech/manager/infrastructure/add/cafeteriaitems')}}">
    ...
    <!-- /.card-header -->
      ...
      <thead>
            ...
            <tr>
                  ...
                  <td>{{$list->itemno}}</td>
                  <td>{{$list->itemdesc}}</td>
                  <td><a href="{{url('nontech/manager/infrastructure/cafeteria/edit/items')}}/{{$list->id}}" class="btn btn-primary btn-sm">Edit</a></td>
            </tr>
          @endforeach
            </tbody>
       </table>
