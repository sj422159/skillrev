    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-8">
            <div class="small-box bg-info" style="background-image: linear-gradient(to right,darkblue,blue);">
                ...
                <a href="{{url('nontech/manager/Cafeteria/school/info')}}" class="small-box-footer">More Details<i class="fas fa-arrow-circle-right"></i></a>
            </div>
            <div class="small-box bg-info" style="background-image: linear-gradient(to right,darkblue,blue);">
                <div class="inner">
                ...
                <a href="{{url('nontech/manager/Cafeteria/others/info')}}" class="small-box-footer">More Details<i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-8">
            <div class="small-box bg-info" style="background-image: linear-gradient(to right,darkblue,blue);">
                <div class="inner">
                    ...
                    <p>Hostel Cafeteria</p>
                </div>
                <div class="icon">
                    <i class="ion ion-stats-bars"></i>
                </div>                
                <a href="{{url('nontech/manager/Cafeteria/hostel/info')}}" class="small-box-footer">More Details<i class="fas fa-arrow-circle-right"></i></a>
            </div>
            <div class="small-box bg-info" style="background-image: linear-gradient(to right,darkblue,blue);">
                <div class="inner">
                ...
                <a href="{{url('nontech/manager/cafeteria/feedback/reports')}}" class="small-box-footer">More Details<i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
         ...
         <div class="col-lg-4 col-8">
            <div class="small-box bg-info" style="background-image:linear-gradient(to right,red,orange);">
                <div class="inner">
                    <h3 style="color: #fff" id="profiles">{{$foodcat}}</h3>
                    <p>Food Category</p>
                </div>
                <div class="icon">
                    <i class="ion ion-stats-bars"></i>
