                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    <a href="{{url('nontech/manager/cafeteria/repair/reports')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Cafeteria Repairs</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{url('nontech/manager/cafeteria/items/reports')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Items Reports</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{url('nontech/manager/cafeteria/feedback/reports')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
