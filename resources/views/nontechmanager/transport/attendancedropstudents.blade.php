            ...
            <div class="card" style="margin-top:20px">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <form action="{{url('nontech/manager/attendence/drop/save')}}" method="post">
                        @csrf
                        <div class="row">
                        <div class="col-12 col-sm-3 mt-2 mt-sm-0" style="display: flex;flex-direction: column;">
                        <label>Drop-Departure</label>
                        <input type="time" class="form-control" required="true" name="dropdeparturetime">  
                        </div>
                        <div class="col-12 col-sm-3 mt-2 mt-sm-0" style="display: flex;flex-direction: column;">
                        <label>Drop-Arrival</label>
                        <input type="time" class="form-control" required="true" name="droparrivaltime">  
                        </div>
                        <div class="col-12 col-sm-3 mt-2 mt-sm-0" style="display: flex;flex-direction: column;">
                        <label>Drop-Departure Delay</label>
                        <input type="text" class="form-control" value="No Delay" name="dropdeparturereason">
                        </div>
                        <div class="col-12 col-sm-3 mt-2 mt-sm-0" style="display: flex;flex-direction: column;">
                        <label>Drop-Arrival Delay</label>
                        <input type="text" class="form-control" value="No Delay" name="droparrivalreason">  
                        </div>
                        </div>
