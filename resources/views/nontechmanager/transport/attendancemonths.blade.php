@extends('nontechmanager/transport/layout') @section('title','Date') @section('Dashboard_select','active extra') @section('container') <style type="text/css"></style>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{url('nontech/manager/attendance/view/students/bydate')}}" method="post">
    @csrf
    <div class="form-row">
...
jQuery(document).ready(function(){
    jQuery('#subbranch').change(function (){
        ...
        jQuery.ajax({
            url:'{{url("nontech/manager/attendance/view/dates")}}',
            type:'get',
