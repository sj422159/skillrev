    ...
    <div class="col-12">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title" style="color:#fff !important;">BED ASSIGN</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{url('nontech/manager/hostel/bed/assign/save')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="col-12 col-sm-4 mt-2 mt-sm-0">
                     ...
                     <div class="col-12 col-sm-4 mt-2 mt-sm-0">
                        ...
                        <input type="text" class="form-control" id="jobgroup" required="true" placeholder="Enter Room Name" name="" value="{{$data[0]->itemno}}" readonly>
                    </div>
                </div>
                 <div class="form-row mt-2">
