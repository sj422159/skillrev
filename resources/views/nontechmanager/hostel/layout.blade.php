...
<head>
    ...
    <!-- Bootstrap Bundle with Popper.js (required for modal and other components) -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js"></script>

    <!-- jQuery (required for the edit button's click handler to work) -->
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    <a href="{{url('nontech/manager/hostel/allocations/reports')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Bed Allocations</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{url('nontech/manager/hostel/infrastructure/repair/reports')}}"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Infrastructure Repairs</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{url('nontech/manager/hostel/food/reports')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Food Report</p>
                                    </a>
                                </li>
