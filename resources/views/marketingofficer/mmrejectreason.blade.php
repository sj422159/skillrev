...
@section('page_title','Reject Reason')
              ...
              <div class="multisteps-form__panel shadow p-4 rounded bg-white js-active" data-animation="FadeIn">
                ...
                <div class="multisteps-form__content">
                  ...
                  <div class="button-row d-flex mt-4">
                    <a href="{{url('employee/marketingofficer/coldcall/3')}}"><button type="button" class="btn btn-danger btn-sm" style="margin-left:10px !important;">Back</button></a>
                  </div>
                </div>
              </div>
              </form>
