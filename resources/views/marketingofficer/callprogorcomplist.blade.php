        ...
        @foreach($data as $list)
            <tr>   
                ...
                <td>
                    ...
                    <span class="right badge badge-success">Completed</span>
                    @endif
                </td>  
                <td>
                    @if($list->status==3 && $list->mmreject==0)
                    ...
                    @elseif($list->status==3 && $list->mmreject==1)
                    <a href="{{url('employee/marketingofficer/coldcall/mmreject')}}/{{$list->id}}"><span class="right badge badge-danger">view reason</span></a>
                    @elseif($list->status==4)
                    <span class="right badge badge-info">Not Applicable</span>
                    @endif
                </td>  
