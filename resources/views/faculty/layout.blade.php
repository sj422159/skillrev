    ...
    <ul class="navbar-nav ml-auto">
     <li class="nav-item dropdown dropdown-hover">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow" style="left:auto; right:10px;">
              <li><a href="{{url('faculty/profile')}}" class="dropdown-item">Change Password </a></li>
              <li><a href="{{url('faculty/logout')}}" class="dropdown-item">Logout</a></li>
            </ul>
          </li>     
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:rgba(116, 52, 16, 1);">
   ...
   <a href="#" class="brand-link">
     <img src='{{asset("assets/images/clg.png")}}' alt="John Doe" alt="AdminLTE Logo"  style="width:40px;height:40px" />
      <span class="brand-text font-weight-dark" style="color:white;"><?Php echo session()->get('FACULTY_Name'); ?></span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item menu-open">
            <a  href="{{url('faculty/dashboard')}}" class="nav-link" class="@yield('dashboard_select')">
          ...
          <?php
            ...
            $rescheduledataopt=DB::table('rescheduletimetables')
                            ...
                            ->where('tprofileid',$fid)
                            ->get();
            $rescheduledclasses=count($rescheduledata)+count($rescheduledataopt);
          ?>
          <li class="nav-item">
            <a  href="{{url('faculty/schedule/list')}}" class="nav-link" class="@yield('dashboard_schedule')">
              ...
              <p>
               <?php 
                ...
                <?php
                 ...
                 ?>
                  <b style="color:lightgreen;">Rescheduled Class </b> <span class="right badge badge-primary"><?php echo $rescheduledclasses;?></span>
                <?php
                }
              ?>
              </p>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
              <li class="nav-item">
                <a href="{{url('faculty/assignment/assigned')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Assigned</p>
                </a>
              </li>
              <li class="nav-item">
                <a  href="{{url('faculty/assignment/submitted')}}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Submitted</p>
                </a>
              </li>
              <li class="nav-item">
                <a  href="{{url('faculty/assignment/corrected')}}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Corrected</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('faculty/assignment/completed')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Completed</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
              <li class="nav-item">
            <a  href="{{url('faculty/reports')}}" class="nav-link" class="">
               <i class="far fa-circle nav-icon"></i>
              <p>
               Academic Reports
              </p>
          ...
          <li class="nav-item">
            <a  href="{{url('faculty/assignments')}}" class="nav-link" class="">
               <i class="far fa-circle nav-icon"></i>
              <p>
               Assignment Reports
              </p>
        ...
        <li class="nav-item">
            <a  href="{{url('faculty/attendance/view/months')}}" class="nav-link" class="nav-link @yield('report_select')">
              <i class="far fa-circle nav-icon"></i>
              <p>
               Attendance Reports
              </p>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
          <li class="nav-item">
            <a  href="{{url('faculty/analytics')}}" class="nav-link" class="">
               <i class="far fa-circle nav-icon"></i>
              <p>
               Academic Analytics
              </p>
          ...
          <li class="nav-item">
            <a  href="{{url('faculty/analytic/assignment')}}" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>
          ...
          <li class="nav-item">
            <a  href="{{url('faculty/analytics/attendance')}}" class="nav-link" class="nav-link @yield('report_select')">
              <i class="far fa-circle nav-icon"></i>
