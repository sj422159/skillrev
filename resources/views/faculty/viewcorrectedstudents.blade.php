...
@section('title','Assignments Corrected Students')
        ...
        <div class="card-body">
          <div class="tab-content">
            <div class="tab-pane active" id="tab_1">
              <div class="row">
                <div class="col-lg-12">
                <form action="{{url('faculty/assignment/moveto/completed')}}" method="post"  enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="assignmentid" value="{{$assignmentid}}">
                <button type="submit" class="btn btn-primary btn-sm" style="margin-left:20px;">Move To Completed</button>
                </form>
                    ...
                    <table id="example1" class="display nowrap" style="width:100%   ">
                      ...
                      <tbody> @php $count=1; @endphp @foreach($data as $list) 
                        <tr id="list">
                          ...
                          <a href="#" class="btn btn-info btn-sm" disabled>View</a>
                          @elseif($list->status==3)
                          <a href="{{url('faculty/assignment/corrected/view/details')}}/{{$list->id}}"class="btn btn-info btn-sm">View</a>
                          @elseif($list->status==4)
