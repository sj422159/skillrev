...
<form action="{{url('faculty/analytics/assignment/fetch')}}" method="post">
    @csrf
    <div class="form-row">
...
function  reload(that) {
    ...
    if(type==1){
        ...
        $.ajax({
              url:'{{url("faculty/analytic/assignment/notcompleted")}}',
              type:'GET',
        ...
        $.ajax({
              url:'{{url("faculty/analytic/assignment/completed")}}',
              type:'GET',
              data:{assignment:assignment},
              dataType: "json",
              success:function(sdata){
