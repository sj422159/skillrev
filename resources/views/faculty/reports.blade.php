...
<form action="{{url('faculty/reports/sectionwise')}}" method="post">
    @csrf
    <div class="form-row">
                      ...
                      <tbody>
                         ...
                         <tr>
                          ...
                          <td>{{$list->trainingname}}</td> 
                            ...
                            @if($list->prereport!="0")
                           <a href="{{url('faculty/examreport')}}/{{$list->prereport}}" class="btn btn-primary btn-sm">Pre</a>
                           ...
                           <a href="{{url('faculty/assignmentreport')}}/{{$list->studentassignmentid}}" class="btn btn-info btn-sm">Assignment</a> 
                           @else
                           ...
                           @endif
                            ...
                            @else
                              <a href="{{url('faculty/examreport')}}/{{$list->postreport}}" class="btn btn-success btn-sm">Post</a>
                            @endif	
                          </td>
                         	</td>
                         </tr>
...
<script type="text/javascript"> 
  ...
  function sec(that){
          ...
          var sectionid=$('#class').attr('data-val');
           ...
           $('#section').html('');
            $.ajax({
              url:'{{url("faculty/classby/section/{id}")}}',
              type:'GET',
              data:{id:classid},
              dataType: "json",
