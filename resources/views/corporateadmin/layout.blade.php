...
<head>
    ...
    <link href='{{ asset('registerexamform/vendor/font-awesome-5/css/fontawesome-all.min.css') }}' rel="stylesheet"
        media="all">
    <link href='{{ asset('registerexamform/vendor/mdi-font/css/material-design-iconic-font.min.css') }}'
        rel="stylesheet" media="all">
    <!-- Bootstrap CSS-->
    <link href='{{ asset('registerexamform/vendor/bootstrap-4.1/bootstrap.min.css') }}' rel="stylesheet"
        media="all">
    <!-- Vendor CSS-->
    ...
    <link href='{{ asset('registerexamform/vendor/css-hamburgers/hamburgers.min.css') }}' rel="stylesheet"
        media="all">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown dropdown-hover">
                    <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="true" class="nav-link dropdown-toggle" style="color:#fff !important">Account</a>
                    <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow"
                        style="left:auto; right:10px;">
                        <li><a href="{{ url('corporateadmin/profile') }}" class="dropdown-item">Change Password </a>
                        </li>
                        <li><a href="{{ url('corporateadmin/logout') }}" class="dropdown-item">Logout</a></li>
                    </ul>
                </li>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:rgba(116, 52, 16, 1);">
            ...
            <a href="#" class="brand-link">
                ...
                <span class="brand-text font-weight-dark"
                    style="color:white;"><?php echo session()->get('CORPORATEADMIN_Name'); ?></span>
            </a>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column"data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{ url('corporateadmin/dashboard') }}" class="nav-link">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>Dashboard</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('corporateadmin/homepage/events') }}" class="nav-link">
                        ...
                        {{-- New Layouts --}}
                        <li class="nav-item">
                          <a href="{{ url('corporateadmin/homepage/highlights') }}" class="nav-link">
                              <i class="nav-icon fas fa-bookmark"></i>
                              <p>
                                HomePage
                          ...
                          <ul class="nav nav-treeview" style="display: none;">
                              <li class="nav-item">
                                  <a href="{{ url('corporateadmin/homepage/slideshow') }}" class="nav-link">
                              ...
                              <li class="nav-item">
                                  <a href="{{ url('corporateadmin/homepage/steps') }}" class="nav-link">
                                      <i class="far fa-circle nav-icon"></i>
                                      <p>
                                          Steps
                                      </p>
                              ...
                              <li class="nav-item">
                                  <a href="{{ url('corporateadmin/homepage/stats') }}" class="nav-link">
                                      <i class="far fa-circle nav-icon"></i>
                                      <p>
                                          Stats
                                      </p>
                              ...
                              <li class="nav-item">
                                  <a href="{{ url('corporateadmin/homepage/testimonials') }}" class="nav-link">
                                      <i class="far fa-circle nav-icon"></i>
                                      <p>
                                          Testimonials
                                      </p>
                      ...
                      <li class="nav-item">
                          <a href="{{ url('corporateadmin/homepage/courses') }}" class="nav-link">
                              <i class="nav-icon fas fa-bookmark"></i>
                              <p>Courses Page</p>
                          </a>
                      </li>
                      <li class="nav-item">
                          <a href="{{ url('corporateadmin/homepage/job-role') }}" class="nav-link">
                              <i class="nav-icon fas fa-bookmark"></i>
                              <p>Top Job-Roles Page</p>
                          </a>
                      </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    <a href="{{ url('corporateadmin/school/list') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            User Details
                                        </p>
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('corporateadmin/content/data') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Content
                                        </p>
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('corporateadmin/questions/data') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Question Bank
                                        </p>
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('corporateadmin/assignment/data') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Assignment
                                        </p>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    <a href="{{ url('corporateadmin/users') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Users
                                        </p>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    <a href="{{ url('corporateadmin/infrastructure/items') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
