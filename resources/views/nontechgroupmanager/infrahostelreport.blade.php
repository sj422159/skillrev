...
@section('title','Hostel Infrastructure')
...
@if(session()->has('success'))
    ...
    @endif
<form action="{{url('nontech/groupmanager/infra/hostel/infobyfilter')}}" method="post">
    @csrf
    <div class="form-row">
        ...
        <div class="col-12 col-sm-3 mt-4 mt-sm-0">
            ...
            <a href="{{url('nontech/groupmanager/infra/hostel/info/export')}}/{{$id}}">
...
jQuery(document).ready(function(){
           ...
           $('#domain').html('');
            $.ajax({
              url:'{{url("nontech/groupmanager/infra/hostels/getroom")}}',
              type:'GET',
              data:{cid:cid},
              dataType: "json",
