...
@if(session()->has('success'))
    ...
    @endif
<form action="{{url('nontech/groupmanager/food/byfilter/feedback')}}" method="post">
    @csrf
    <div class="form-row">
        ...
        <div class="col-12 col-sm-3 mt-sm-0">
            ...
            <a href="{{url('nontech/groupmanager/food/feedback/export')}}/{{$aid}}">
