...
@if(session()->has('success'))
    ...
    @endif
<form action="{{url('nontech/groupmanager/hostel/allocation/filter')}}" method="post">
    @csrf
    <div class="form-row">
        ...
        <div class="col-12 col-sm-3 mt-4 mt-sm-0">
            ...
            <a href="{{url('nontech/groupmanager/bedallocation/info/export')}}/{{$id}}">
