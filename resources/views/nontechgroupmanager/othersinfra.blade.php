...
@if(session()->has('success'))
    ...
    @endif
<form action="{{url('nontech/groupmanager/others/infrastructure/infobyfilter')}}" method="post">
    @csrf
    <div class="form-row">
       ...
       <!--  @if(count($data)>0)
        <div class="col-12 col-sm-3 mt-4 mt-sm-0">
            ...
            <a href="{{url('nontech/groupmanager/hostel/infrastructure/infobyfilter/export')}}/{{$id}}">
