       ...
       <tbody style="background-color:#fff">
               ...
               @php
                        ...
                        <tr id="list">
                          <td>{{$count}}</td>
                          <td>{{$list->fname}}</td>
                          <td> <a href="{{url('assignmentcontent/question')}}/{{$list->questioncontent}}"target="_blank">View</a> </td>
                          <td> <a href="{{url('assignmentcontent/answer')}}/{{$list->answercontent}}" target="_blank">View</a></td>
                          <td>	
                          	 <a href="{{url('assignmentcontent/correctanswer')}}/{{$list->correctanswercontent}}" target="_blank">View</a>
                          </td>
                          <td>
                          	 @if($list->status==1)
