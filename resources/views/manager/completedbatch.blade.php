               ...
               @php
                        ...
                        <tr id="list">
                          ...
                          <td>{{$list->trainingname}}</td> 
                           ...
                           <td>{{$list->section}}</td>
                          <td>{{$list->stucount}}</td>
                         <td><a href="{{url('manager/completed/students')}}/{{$list->id}}/" class="btn btn-primary btn-sm">View</a></td>
                         
                          <td>

                          <a href="{{url('manager/post/approve')}}/{{$list->id}}/{{$train}}" class="btn btn-primary btn-sm" style="margin-right: 4px">Post Approve </a>
               ...
               @php
                        ...
                        <tr id="list">
                          ...
                          <td>{{$list->stucount}}</td>
                            ...
                            <td><a href="{{url('manager/completed/students/approved')}}/{{$list->id}}/" class="btn btn-primary btn-sm">View</a></td>  
