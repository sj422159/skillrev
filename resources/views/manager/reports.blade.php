...
@if(count($data)>0)
<a href="{{url('corporate/explicit/jobrole/reports/export')}}/"><button type="button" class="btn btn-primary">Export</button></a>
@endif   
<form action="{{url('manager/reports/sectionwise')}}" method="post">
    @csrf
    <div class="form-row">
          <div class="col-12 col-sm-3 mt-2 mt-sm-0" style="display: flex;justify-content: center;flex-direction: column;align-items: center;">
            <label>CLASS</label>
            <select  class="form-control disabled" required  name="class" disabled required >
                      ...
                      <tbody>
                         ...
                         <tr>
                          ...
                          <td>{{$list->trainingname}}</td> 
                            ...
                            @if($list->prereport!="0")
                           <a href="{{url('manager/examreport')}}/{{$list->id}}/{{$list->prereport}}" class="btn btn-primary btn-sm">Pre</a>
                           ...
                           <a href="{{url('manager/assignmentreport')}}/{{$list->studentassignmentid}}" class="btn btn-info btn-sm">Assignment</a> 
                           @else
                           ...
                           @endif
                            ...
                            @else
                              <a href="{{url('manager/examreport')}}/{{$list->id}}/{{$list->postreport}}" class="btn btn-success btn-sm">Post</a>
                            @endif	
                          </td>
                         	</td>
                         </tr>
