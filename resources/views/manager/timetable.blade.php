...
<link rel="stylesheet" href="https://cdn.datatables.net/buttons/1.2.4/css/buttons.dataTables.min.css">
 <div class="container-fluid">
                ...
                <h3 class="card-title"><b> &nbsp &nbsp TIME - TABLE</b></h3>
                  ...
                  <form action="{{url('manager/gettimetable')}}" method="post" >
                        @csrf
                   <div class="row col-12">

                   
                   <div class="col-12 col-sm-3 mt-4 mt-sm-0">
                 <select class="form-control" required name="class" data-val="{{$section}}" id="clasy" onchange="sec(this)">
            ...
            <select  class="form-control" required  name="section" id="section" required >
                <option value="">Select Section</option>
                  ...
                  <div class="col-12 col-sm-4 mt-2" style="font-size:18px">
                      <b>{{$day}} ,  {{$date}}</b>
                  </div>
              </form>
          ...
          var sectionid=$('#clasy').attr('data-val');
           ...
           $('#section').html('');
            $.ajax({
              ...
              success:function(data)
              {
                $('#section').prop('disabled', false).append('<option value="">Select Section</option>');
                 $.each(data, function(key,section)
                 {   
                   if(sectionid==section.id){
                       $('#section').prop('disabled', false).append('<option value="'+section.id+'" selected >'+section.section+'</option>');
