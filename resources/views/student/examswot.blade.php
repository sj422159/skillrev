...
<div class="col-6" style="padding:10px;padding-top: 20px;display: flex;align-items: center;flex-direction: column;">
  ...
  <div class="row">
      <div style="width:240px;display:flex;align-items:center;flex-direction:column;border:5px solid #00000060;padding:5px ;margin: 3px;">
          ...
          <div class="row" style="display:flex;align-items:center"><h3>{{$cc}}%</h3>
      ...
      <div style="width: 240px;display:flex;align-items:center;flex-direction:column;border:5px solid #00000060;padding:5px ;margin: 3px;">
         <!--  <div>Confident-Wrong</div> -->
          <div class="row" style="display:flex;align-items:center"><h3>{{$cnc}}%</h3>
           @if($cnc>60)
            <i class="fas fa-thumbs-down" style="font-size:40px;margin:5px;color:red;"></i>
           @elseif($cnc<60 && $cnc>30)
           <i class="fas fa-hand-point-up"  style="font-size:40px;margin:5px;color:blue;"></i>
           @elseif($cnc<30)
             <i class="fas fa-thumbs-up" style="font-size:40px;margin:5px;color:green;"></i>
           @endif
  ...
  <div class="row">
        ...
        <div style="width: 240px;display:flex;align-items:center;flex-direction:column;border:5px solid #00000060;padding:5px ;margin: 3px;">
          ...
          <div class="row" style="display:flex;align-items:center"><h3>{{$nc}}%</h3>
             @if($nc>70)
            <i class="fas fa-thumbs-down"style="font-size:40px;margin:5px;color:red;"></i>
           @elseif($nc<70 && $nc>30)
           <i class="fas fa-hand-point-up" style="font-size:40px;margin:5px;color:blue;"></i>
       ...
       <div style="width: 240px;display:flex;align-items:center;flex-direction:column;border:5px solid #00000060;padding:5px ;margin: 3px;">
         <!--  <div>Not Confident-Wrong</div> -->
          <div class="row" style="display:flex;align-items:center"><h3>{{$nnc}}%</h3>
          
            @if($nnc>70)
             <i class="fas fa-thumbs-up"style="font-size:40px;margin:5px;color:green;"></i>
           
           @elseif($nnc<70 && $nnc>30)
           <i class="fas fa-hand-point-up" style="font-size:40px;margin:5px;color:blue;"></i>
           @elseif($nnc<30)
             <i class="fas fa-thumbs-down"style="font-size:40px;margin:5px;color:red;"></i>
           @endif
...
<div class="col-12" style="display:flex;align-items: center;flex-direction: column;">
  <h3 style="color:green;text-align: center;"> &nbsp SUBMITTED <br>SUCCESSFULLY</h3><br>
<a href="{{url('exam/reports')}}"><button class="btn btn-success">Check Reports</button></a><br><br>
</div>
