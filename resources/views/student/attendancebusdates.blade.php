        ...
        <div class="col-12">
            <div class="card" style="margin-top:20px">
                <div class="card-header d-flex p-0">
                    <h3 class="card-title p-3">Bus Attendance</h3>
                    <!-- <ul class="nav nav-pills ml-auto p-2">
                  <li class="nav-item"><a class="nav-link active" href="#tab_1" data-toggle="tab">Pickup</a></li>
                  <li class="nav-item"><a class="nav-link" href="#tab_2" data-toggle="tab">Drop</a></li>
                </ul> -->
                </div>
                <div class="card-body">
                            ...
                            <div class="table-responsive table" style="padding:20px">
                                <table id="example1" class="display nowrap" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $c=0;
                                        @endphp
                                        @foreach($pickupattendance as $list)
                                        <tr class="tr-shadow">
                                            <td>{{$date[$c]}}</td>
                                            <td>
