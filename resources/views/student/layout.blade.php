    ...
    <ul class="navbar-nav ml-auto">
     <li class="nav-item dropdown dropdown-hover">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow" style="left:auto; right:10px;">
              <li><a href="{{url('student/profile')}}" class="dropdown-item">Change Password </a></li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:rgba(116, 52, 16, 1);">
   ...
   <a href="#" class="brand-link">
     <img src='{{asset("assets/images/clg.png")}}' alt="John Doe" alt="AdminLTE Logo"  style="width:40px;height:40px" />
      <span class="brand-text font-weight-dark" style="color:white;"><?Php echo session()->get('STUDENT_Name'); ?></span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item menu-open">
            <a  href="{{url('student/dashboard')}}" class="nav-link" class="@yield('dashboard_select')">
          ...
          <li class="nav-item">
            <a href="{{url('student/competition')}}" class="nav-link @yield('manage_select')">
          ...
          <li class="nav-item">
            <a href="{{url('student/content/skillattribute')}}" class="nav-link @yield('manage_select')">
              <i class="nav-icon fas fa-bookmark"></i>
              <p>
                Training Content
              </p>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
              <li class="nav-item">
                <a href="{{url('student/class/timetable')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Class</p>
                </a>
              </li>
              <li class="nav-item">
                <a  href="{{url('student/bus/timetable')}}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Bus</p>
                </a>
              </li>
            ...
            <li class="nav-item">
            <a href="{{url('student/food/schedule')}}" class="nav-link @yield('manage_select')">
              <i class="nav-icon fas fa-bookmark"></i>
              <p>
                Food Management
              </p>
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
              <li class="nav-item">
                <a href="{{url('student/fees/selection')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Current Year Selection</p>
                </a>
              </li>
              <li class="nav-item">
                <a  href="{{url('student/fees/payment')}}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Current Year Payment</p>
                </a>
              </li>
              <li class="nav-item">
                <a  href="{{url('student/fees/pending/reports')}}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                Last Year Fee Report
                </p>
                </a>
              </li>
            </ul>
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
          <li class="nav-item">
                <a  href="{{url('exam/reports')}}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                Academic Reports
                </p>
          ...
          <li class="nav-item">
            <a  href="{{url('student/attendance/view/months')}}" class="nav-link" >
              <i class="far fa-circle nav-icon"></i>
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
          <li class="nav-item">
            <a  href="{{url('student/analytics/attendance')}}" class="nav-link" >
              <i class="far fa-circle nav-icon"></i>
