...
<a href="{{url('supervisor/apply/leave/addapplyleave')}}">
        ...
        <table id="example1" class="display wrap" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @if($list->status==1)
                        <td>
                        <a href="{{url('supervisor/apply/leave/addapplyleave')}}/{{$list->id}}"><button type="button" class="btn btn-success btn-sm ">Edit</button>
                        </a>
                        <a href="{{url('supervisor/apply/leave/delete')}}/{{$list->id}}"><button type="button" class="btn btn-danger btn-sm">Delete</button>
                        </a>
                        </td>
                    @else
                        <td>
