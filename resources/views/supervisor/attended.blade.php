...
@section('title','Attended Batch Students')
       ...
       <tbody style="background-color:#fff">
               ...
               @php
                        ...
                        <tr id="list">
                          ...
                          <td><a href="{{url('supervisor/attended/students/assignments/view')}}/{{$list->id}}" class="btn btn-primary btn-sm">View Assignments</td>
