    ...
    <div class="col-12">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title" style="color:#fff !important;">MANAGER SCHEDULE CLASS</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{url('groupmanager/manager/schedule/day')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                <div class="form-row">
 ...
 var clas=0;
  function per(that){
    ...
    $('#period').html('');
     $('#subject').html('');
      $.ajax({
              url:'{{url("groupmanager/manager/getperiod/")}}',
              type:'GET',
       ...
       $.ajax({
              url:'{{url("groupmanager/manager/getsubject/")}}',
              type:'GET',
     ...
     function getm(that){
       ...
       var subs=that.value;
        $('#modules').html('');
       $.ajax({
              url:'{{url("groupmanager/manager/getmodule/")}}',
              type:'GET',
