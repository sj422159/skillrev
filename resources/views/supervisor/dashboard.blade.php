...
@section('container')
    ...
    <div class="main-content"style="padding: 0px;">
        ...
        <div class="row">
            <div class="card card-widget widget-user" style="width:300px;height: 280px;margin:0px 20px 0px 15px;">
                <div class="widget-user-header bg-primary"
                    ...
                    <h3 class="widget-user-username" style="color:#fff";><?php echo session()->get('SUPERVISOR_Name'); ?>
                    </h3>
                </div>
                <div class="widget-user-image">
                    @foreach ($image as $list)
                        <img class="img-circle elevation-2" src="{{ asset('supervisorimages') }}/{{ $list->image }}"
                            alt="User Avatar">
                    @endforeach
                </div>
                <div class="card-footer" style="background-color: #fff;">
                    <div class="row col-12"
                        ...
                        <a href="{{ url('supervisor/adddetails') }}" class="btn btn-block btn-primary btn-sm col-6"
                            style="background-image: linear-gradient(to right,#5235ba,#7e3ded);">
            ...
            <div class="col-lg-4 col-8">
                <div class="small-box bg-info" style="background-image: linear-gradient(to right,darkblue,blue);">
                    ...
                    <a href="{{ url('supervisor/studentdetails') }}" class="small-box-footer">More Details<i
                ...
                <div class="small-box bg-info" style="background-image: linear-gradient(to right,darkblue,blue);">
                    ...
                    <a href="{{ url('supervisor/student/assignations') }}" class="small-box-footer">More Details<i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-4 col-8">
                <div class="small-box bg-info" style="background-image: linear-gradient(to right,darkblue,blue);">
                    ...
                    <a href="{{ url('supervisor/approve/leave') }}" class="small-box-footer">More Details<i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
                <div class="small-box bg-info" style="background-image: linear-gradient(to right,darkblue,blue);">
                    <div class="inner">
                    ...
                    <a href="{{ url('groupmanager/competition') }}" class="small-box-footer">More Details<i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-8">
                    @if ($count == 1)
                        <div class="small-box bg-danger"
                            style="background-image:linear-gradient(to right,#283048,#859398);">
                        @elseif($count == 2)
                            <div class="small-box bg-danger"
                                style="background-image:linear-gradient(to right,#cc2b5e,#753a88);">
                            @elseif($count == 3)
                                <div class="small-box bg-danger"
                                    style="background-image:linear-gradient(to right,red,orange);">
                                @elseif($count == 4)
                                    <div class="small-box bg-danger"
                    ...
                    <a href="{{ url('supervisor/assigned') }}/{{ $list->id }}" class="small-box-footer">More Details
        ...
        <div class="col-lg-4 col-8">
            ...
            <a href="{{ url('supervisor/attended') }}/{{ $list->id }}" class="small-box-footer">More Details <i
                    class="fas fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <div class="col-lg-4 col-8">
        ...
        <a href="{{ url('supervisor/completed') }}/{{ $list->id }}" class="small-box-footer"> More Details <i
                class="fas fa-arrow-circle-right"></i></a>
    </div>
    </div>
    @php
