...
@section('title','Group Manager Schedule')
@section('d','active')
@section('container')
...
<div class="row">
    <div class="col-12">
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{url('groupmanager/own/schedule/day')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                <div class="form-row">
 ...
 var clas=0;
  function per(that){
    ...
    $('#period').html('');
     $('#subject').html('');
      $.ajax({
              url:'{{url("groupmanager/own/getperiod/")}}',
              type:'GET',
       ...
       $.ajax({
              url:'{{url("groupmanager/own/getsubject/")}}',
              type:'GET',
     ...
     function getm(that){
       ...
       var subs=that.value;
        $('#modules').html('');
       $.ajax({
              url:'{{url("groupmanager/own/getmodule/")}}',
              type:'GET',
