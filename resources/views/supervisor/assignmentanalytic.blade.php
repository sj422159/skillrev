...
<form action="{{url('supervisor/analytics/assignment/fetch')}}" method="post">
    @csrf
    <div class="form-row">
...
function  reload(that) {
    ...
    if(type==1){
        ...
        $.ajax({
              url:'{{url("supervisor/analytic/assignment/notcompleted")}}',
              type:'GET',
        ...
        $.ajax({
              url:'{{url("supervisor/analytic/assignment/completed")}}',
              type:'GET',
              data:{assignment:assignment},
              dataType: "json",
              success:function(sdata){
  ...
  function sec(that){
         ...
         function gettrain(that){
          ...
          var trainid=$('#section').attr('data-sec');
           ...
           $('#train').html('');
            $.ajax({
              url:'{{url("supervisor/trainings/get")}}',
              type:'GET',
