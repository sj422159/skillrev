...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{url('supervisor/fees/index/students/bysection')}}" method="post">
    @csrf
    <div class="form-row">
                                ...
                                <table id="example1" class="display nowrap" style="width:100%   ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="tr-shadow">
                                            ...
                                            <td>
                                            @if($list->visible==1)
                                            <a href="{{url('supervisor/fees/index/students/view/structure')}}/{{$list->id}}">
                                           ...
                                           <td>
                                            @if($list->visible==1)
                                            <a href="{{url('supervisor/fees/index/students/export')}}/{{$list->id}}">
