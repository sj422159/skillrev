@extends('classteacher/layout') @section('title','Student') @section('Dashboard_select','active extra') @section('container') <style type="text/css"></style>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1">
                            <div class="table-responsive table" style="padding:20px">
                                <form action="{{url('classteacher/attendence/save')}}" method="post">
                                @csrf
                                ...
                                <div class="button-row d-flex mt-2" style="display:flex;align-items: center;justify-content: center;">
                                    ...
                                    @else
                                    <a href="{{url('classteacher/attendance/view/dates')}}">
