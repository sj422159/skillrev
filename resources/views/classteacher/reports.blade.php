...
<form action="{{url('classteacher/reports/sectionwise')}}" method="post">
    @csrf
    <div class="form-row">
        ...
        <div class="col-12 col-sm-3 mt-2 mt-sm-0" style="display: flex;justify-content: center;flex-direction: column;align-items: center;">
            <label>SECTION</label>
            <select  class="form-control" required  name="section" disabled required >
                      ...
                      <tbody>
                         ...
                         <tr>
                          ...
                          <td>{{$list->trainingname}}</td> 
                           ...
                           <a href="{{url('classteacher/assignmentreport')}}/{{$list->studentassignmentid}}" class="btn btn-info btn-sm">Assignment</a> 
                           @else
