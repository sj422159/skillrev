...
<div class="main-content"style="padding: 0px;">
    ...
    <script>
    swal({
    title:"Today's Student Attendance is not Completed",
    text: "As the Class Teacher, it is imperative to complete the Attendance Report of your class before the completion of the FIRST period. Please complete it ASAP.",
    icon: "warning",
    });
    </script>
    @endif
    ...
    <div class="row">
        <div class="card card-widget widget-user" style="width:300px;height: 280px;margin:0px 20px 0px 15px;">
            <div class="widget-user-header bg-primary" style="background-image: linear-gradient(to right,#5235ba,#7e3ded);">
                <h3 class="widget-user-username" style="color:#fff";><?php echo $name; ?></h3>
            </div>
            <div class="widget-user-image">
                @foreach($image as $list)
                <img class="img-circle elevation-2" src="{{asset('facultyimages')}}/{{$list->image}}" alt="User Avatar">
                @endforeach
            </div>
            <div class="card-footer" style="background-color: #fff;">
                <div class="row col-12" style="display:flex;align-items:center;justify-content: center;padding: 0;margin: 0;">
                    <a href="{{url('classteacher/adddetails')}}" class="btn btn-block btn-primary btn-sm col-6" style="background-image: linear-gradient(to right,#5235ba,#7e3ded);">
        ...
        <div class="col-lg-4 col-8">
            <div class="small-box bg-info" style="background-image: linear-gradient(to right,darkblue,blue);">
                ...
                <a href="{{url('classteacher/studentdetails')}}" class="small-box-footer">More Details<i class="fas fa-arrow-circle-right"></i></a>
            </div>
            <div class="small-box bg-info" style="background-image: linear-gradient(to right,darkblue,blue);">
                <div class="inner">
        ...
        <div class="col-lg-4 col-8"> 
            ...
            @endif
                ...
                <a href="{{url('classteacher/assigned')}}/{{$list->id}}" class="small-box-footer">More Details  <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-4 col-8"> 
            @if($count==1)
            ...
            @endif
                ...
                <a href="{{url('classteacher/attended')}}/{{$list->id}}" class="small-box-footer">More Details  <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-4 col-8">
            @if($count==1)
            ...
            @endif
                ...
                <a href="{{url('classteacher/completed')}}/{{$list->id}}" class="small-box-footer"> More Details  <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        @php
        $count++;
