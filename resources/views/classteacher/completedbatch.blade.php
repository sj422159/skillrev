               ...
               @php
                        ...
                        <tr id="list">
                          ...
                          <td>{{$list->trainingname}}</td> 
                           ...
                           <td>{{$list->section}}</td>
                          <td>{{$list->stucount}}</td>
                         <td><a href="{{url('classteacher/completed/students')}}/{{$list->id}}/" class="btn btn-primary btn-sm">View</a></td>
               ...
               @php
                        ...
                        <tr id="list">
                          ...
                          <td>{{$list->stucount}}</td>
                            ...
                            <td><a href="{{url('classteacher/completed/students/approved')}}/{{$list->id}}/" class="btn btn-primary btn-sm">View</a></td>  
