        ...
        <div class="card">
            <div class="card-header">
                <div class="form-row mt-4">
                    ...
                    <form action="{{url('admin/questions/upload')}}" enctype="multipart/form-data" method="post"
                        class="col-12"> @csrf
                        ...
                        <div class="form-row mt-4">
                            ...
                            <div class="col-12 col-sm-3 mt-4 mt-sm-0">
                                ...
                                <select class="form-control" aria-required="true" required="true" aria-invalid="false"
                            ...
                            <div class="col-12 col-sm-3 mt-4 mt-sm-0">
                                <label>Subject</label>
                                <select class="form-control" id="domain" required="true" aria-required="true"
                                    aria-invalid="false" name="domain">
                                    <option value="">Select</option>
                                </select>
                            </div>
                            <div class="col-12 col-sm-3 mt-4 mt-sm-0">
