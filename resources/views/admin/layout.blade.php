...
<head>
    ...
    <link href='{{asset("registerexamform/vendor/font-awesome-4.7/css/font-awesome.min.css")}}' rel="stylesheet"
        media="all">
    <link href='{{asset("registerexamform/vendor/font-awesome-5/css/fontawesome-all.min.css")}}' rel="stylesheet"
        media="all">
    <link href='{{asset("registerexamform/vendor/mdi-font/css/material-design-iconic-font.min.css")}}' rel="stylesheet"
        media="all">
    <!-- Bootstrap CSS-->
    ...
    <link href='{{asset("registerexamform/vendor/bootstrap-progressbar/bootstrap-progressbar-3.3.4.min.css")}}'
    ...
    <link href='{{asset("registerexamform/vendor/perfect-scrollbar/perfect-scrollbar.css")}}' rel="stylesheet"
        media="all">
    <!-- Main CSS-->
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light"
            style="background-image: linear-gradient(to right, #743410,#c99b1c );">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:rgba(116, 52, 16, 1);">
            ...
            <a href="#" class="brand-link">
                <img src='{{asset("assets/images/clg.png")}}' alt="John Doe" alt="AdminLTE Logo"
                    style="width:40px;height:40px" />
                <span class="brand-text font-weight-dark" style="color:white;">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                ...
                                <li class="nav-item">
                                    <a href="{{url('admin/fees/busroute')}}" class="nav-link"
                                ...
                                <li class="nav-item">
                                    <a href="{{url('admin/hostel')}}" class="nav-link"
                                        class="@yield('Questions_select')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Hostel
                                ...
                                <li class="nav-item">
                                    <a href="{{url('admin/infrastructure/group')}}" class="nav-link"
                                        class="@yield('Questions_select')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                    ...
                                    <ul class="nav nav-treeview" style="display: none;">
                                        <li class="nav-item">
                                            <a href="{{url('/controller')}}"
                                                class="nav-link @yield('manager_select')">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>Controller</p>
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a href="{{url('admin/nontech/supervisor')}}" class="nav-link"
                                                class="@yield('manager_select')">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>
                                                    Group Manager
                                        ...
                                        <li class="nav-item">
                                            <a href="{{url('admin/nontech/manager')}}" class="nav-link"
                                                class="@yield('manager_select')">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>
                                                    Manager
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="nav nav-treeview" style="display: none;">
                                        <li class="nav-item">
                                            <a href="{{url('controller/groups')}}" class="nav-link">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>Group</p>
                                            </a>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            <a href="{{url('admin/skillset')}}" class="nav-link"
                                                class="@yield('Questions_select')">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>
                                                    Module
                                        ...
                                        <li class="nav-item">
                                            <a href="{{url('admin/skillattribute')}}" class="nav-link"
                                                class="@yield('Questions_select')">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>
                                                    Chapter
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{url('admin/fees/distance')}}" class="nav-link"
                                                class="@yield('Questions_select')">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>
                                        ...
                                        <li class="nav-item">
                                            <a href="{{url('admin/fees/category')}}" class="nav-link"
                                                class="@yield('Questions_select')">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>
                                                    Fees Category
                                        ...
                                        <li class="nav-item">
                                            <a href="{{url('admin/fees/schedule')}}" class="nav-link"
                                                class="@yield('Questions_select')">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>
                                        ...
                                        <li class="nav-item">
                                            <a href="{{url('admin/transport/fees/schedule/busroutes')}}"
                                                class="nav-link" class="@yield('Questions_select')">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>
                                        ...
                                        <li class="nav-item">
                                            <a href="{{url('admin/fees/discount')}}" class="nav-link"
                                                class="@yield('list')">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>
                                                    Special Discount
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="{{url('admin/periods/portal')}}" class="nav-link"
                                                class="@yield('Questions_select')">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>
                                                    Staff Wise
                                        ...
                                        <li class="nav-item">
                                            <a href="{{url('admin/periods/class')}}" class="nav-link"
                                                class="@yield('Questions_select')">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>
                                                    Class Wise
                                        ...
                                        <li class="nav-item">
                                            <a href="{{url('admin/schedule/index')}}" class="nav-link"
                                                class="@yield('list')">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>
                                                    Subject Wise
                                        ...
                                        <li class="nav-item" style="display:none">
                                            <a href="{{url('admin/periods/subject')}}" class="nav-link"
                                                class="@yield('Questions_select')">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>
                                                    Subject Wise
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    <a href="{{url('admin/assesments')}}" class="nav-link"
                                        class="@yield('Questions_select')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Assesment Creation
                                ...
                                <li class="nav-item">
                                    <a href="{{url('admin/questions/mismatch')}}" class="nav-link"
                                        class="@yield('Questions_select')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Answer Mismatch
                                ...
                                <li class="nav-item">
                                    <a href="{{url('admin/questions/improper')}}" class="nav-link"
                                        class="@yield('Questions_select')">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Improper Question
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="{{url('admin/fees/pending')}}" class="nav-link"
                                                class="@yield('Questions_select')">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>
                                                    Last Year Pending
                                        ...
                                        <li class="nav-item">
                                            <a href="{{url('admin/fees/pending/currentyear')}}" class="nav-link"
                                                class="@yield('Questions_select')">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>
                                        ...
                                        <li class="nav-item">
                                            <a href="{{url('admin/fees/index/students')}}" class="nav-link"
                                                class="@yield('Questions_select')">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="{{url('admin/analytics/pendingfees')}}" class="nav-link"
                                                class="@yield('Questions_select')">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>
                                                    Pending Fees
                                        ...
                                        <li class="nav-item">
                                            <a href="{{url('admin/analytics/currentfees')}}" class="nav-link"
                                                class="@yield('Questions_select')">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>
                                                    Current Year Payment
