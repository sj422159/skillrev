        ...
        <table id="example1" class="display wrap" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @if($list->status==1)
                        <td>
                        <a href="{{url('admin/approve/leave/status/4')}}/{{$list->id}}"><button type="button" class="btn btn-success btn-sm">Approve</button>
               </a>
                   <a href="{{url('admin/approve/leave/status/2')}}/{{$list->id}}"><button type="button" class="btn btn-danger btn-sm">Reject</button>
               </a>
                        </td>
                    @else
                        <td>
                        <a href="#"><button type="button" class="btn btn-success btn-sm disabled">Approve</button>
               </a>
                ...
                <tr>
                    ...
                    @if($list->status==1)
                        <td>
                        <a href="{{url('admin/approve/leave/status/3')}}/{{$list->id}}"><button type="button" class="btn btn-success btn-sm">Approve</button>
               </a>
                   <a href="{{url('admin/approve/leave/status/2')}}/{{$list->id}}"><button type="button" class="btn btn-danger btn-sm">Reject</button>
               </a>
                        </td>
                ...
                @foreach($supervisorleave as $list)
                <tr>
                    <td>{{$count}}</td>
                    <td>Supervisor</td>
                    <td>{{$list->supname}}</td>
