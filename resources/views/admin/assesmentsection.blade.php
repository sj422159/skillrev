        ...
        <div class="card" style="padding:10px !important; ">
            ...
            <div class="card-body" style="padding:10px !important; overflow: hidden;">
                ...
                <div class="form-row mt-4">
                    ...
                    <div class="col-12 col-sm-2 mt-4 mt-sm-0">
                        ...
                        <input type="text" class="form-control" placeholder="Enter" name="sectionname" form="Form2"
                            required="true">
                    </div>
                    ...
                    <div class="col-12 col-sm-2 mt-4 mt-sm-0">
                        ...
                        <select class="form-control" style="width: 100%;" aria-required="true" aria-invalid="false"
                            name="skillgroup" id="country" form="Form2" required="true">
                    ...
                    <div class="col-12 col-sm-2 mt-4 mt-sm-0">
                        <label>Subject :</label>
                        <select class="form-control" style="width: 100%;" id="state" aria-required="true"
                            aria-invalid="false" name="skillset[]" form="Form2" required="true">
                    ...
                    <div class="col-12 col-sm-2 mt-4 mt-sm-0">
                        <label>Module :</label>
                        <select class="form-control" style="width:100%;" id="city" aria-required="true"
                            aria-invalid="false" name="section[]" form="Form2" required="true">
                    ...
                    <div class="col-12 col-sm-2 mt-4 mt-sm-0">
                        <label>Chapter :</label>
                        <select class="form-control" style="width:100%;" id="town" aria-required="true"
                            aria-invalid="false" name="chapter" form="Form2" required="true">
                    ...
                    <!-- 1 means one chapter to select-->
                    @else
                    <div class="col-12 col-sm-2 mt-4 mt-sm-0">
                        <label>Module :</label>
                        <select class="form-control" style="width:100%;" id="city" multiple aria-required="true"
                            aria-invalid="false" name="section[]" form="Form2" required="true">
                            @foreach($skillsets as $list)
                            <option value="{{$list->id}}">{{$list->skillset}}</option>
                            @endforeach
                    ...
                    <!-- 2 mean multiple chapters select-->
                    @endif
            ...
            <div class="col-4 mt-4">
                <button type="submit" class="btn btn-success"
                    style="margin-bottom: 20px !important;margin-left: 10px !important;" form="Form1">Submit</button>
            </div>
            <!-- /.card-body -->
        </div>
        </form>
