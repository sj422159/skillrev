...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{url('admin/fees/pending/students/bysection')}}" method="post">
    @csrf
    <div class="form-row">
        ...
        <div class="col-12 col-sm-3 mt-2 mt-sm-0" style="display:flex;flex-direction: column;">
            ...
            <div class="card" style="margin-top:20px">
                ...
                <div class="card-body">
                    ...
                    <form action="{{url('admin/fees/pending/students/pendingfees/save')}}" method="post" id="formb" enctype="multipart/form-data">
                    @csrf
                        @if(count($students)>0)
                        <button type="submit" form="formb" class="btn btn-primary btn-sm">Save</button>
                        <a href="{{url('admin/fees/pending/students/export')}}/{{$class}}/{{$section}}" class="btn btn-success btn-sm">Export</a>
                        @else
            ...
            <td><input type="file" id="{{$count}}photos" form="formb" name="photos{{$count}}"></td>
                        ...
                        <form action="{{url('admin/fees/pending/students/pendingfees/initial/save')}}" method="post" id="formc" enctype="multipart/form-data">
                        @csrf
                        @if(count($students)>0)
