...
class managertotalfeesanalyticcontroller extends Controller
{
    ...
    public function index(){
       ...
       return view('manager.pendingfeesanalytic',$result); 
    }
    ...
    public function fetch(request $request){
     ...
     public function currentindex(){
       ...
       return view('manager.currentfeesanalytic',$result); 
    }
