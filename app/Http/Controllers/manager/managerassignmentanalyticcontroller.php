...
class managerassignmentanalyticcontroller extends Controller
{
    public function index(){
        ...
        $result['Name']="";
        $result['assignment']=0;
       return view('manager.assignmentanalytic',$result); 
    }
    ...
    public function fetch(request $request){
        ...
        $data=DB::table('studentassignations')->where('classid',$cid)->where('sectionid',$request->post('section'))->where('trainingid',$request->post('training'))->get();
        if(count($data)>0){
