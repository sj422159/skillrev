...
class managerfeescontroller extends Controller{
    ...
    public function pendingfeesstudents(){
        ...
        $result['class']=[];
        $result['section']=[];
        return view('manager.pendingfeesstudents',$result);
    }
    ...
    public function indexfeesstudents(){
        ...
        $result['section']=[];
        $result['paymentcount']=[];
        return view('manager.paidindex',$result);
    }
    ...
    public function feesstructure(Request $request,$id){
        ...
        $result['data']=DB::table('feeselections')
                    ...
                    ->get();
        $result['sid']=$id;
        return view('manager.paidintsallment',$result);
    }
}