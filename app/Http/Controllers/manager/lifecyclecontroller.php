...
class lifecyclecontroller extends Controller
{
    public function assindex($id){
         ...
         $result['data']=DB::table('studentassignations')
                                    ...
                                    ->where('cyclestatus',1)
                                    ->where('studentassignations.mid',$sesid)
        ...
        $result['train']=$id;
      return view('manager.assignedbatch',$result);
    }
    ...
    public function assstudents($id){
        $result['data']=DB::table('studentbookings')
                                  ...
                                  ->get();
       $result['train']=$id;
      return view('manager.assigned',$result);
    }

    public function passed($id,$train){
        $sesid=session()->get('MANAGER_ID');
        $model=studentbooking::find($id);
        $model->manpreapprove=$sesid;
        $model->save();
        return redirect('manager/assigned/students/'.$train);
    }

     public function movetoattended($id,$train){
        $sesid=session()->get('MANAGER_ID');
        $model=studentassignation::find($id);
        $model->cyclestatus=2;
        $model->save();
        return redirect('manager/assigned/'.$train);
    }
     ...
     public function attindex($id){
       ...
       $result['train']=$id;
      return view('manager.attendedbatch',$result);
    }
      ...
      public function attstudents($id){
       ...
       $result['train']=$id;
      return view('manager.attended',$result);
    }
    ...
    public function assignments($id){
        ...
        return view('manager.assignments',$result);
    ...
    public function comstudents($id){
       ...
       $result['train']=$id;
      return view('manager.justcompleted',$result);
    }


    public function movetocompleted($id,$train){
        $sesid=session()->get('MANAGER_ID');
        $model=studentassignation::find($id);
        $model->cyclestatus=3;
        $model->save();
        return redirect('manager/attended/'.$train);
    }
     ...
     public function comindex($id){
       ...
       $result['train']=$id;
      return view('manager.completedbatch',$result);
    }
    ...
    public function comapstudents($id){
        $sesid=session()->get('MANAGER_ID');
         $result['appdata']=DB::table('studentbookings')
                                  ...
                                  ->where('studentbookings.assignid',$id)
                                  ->where('postapprove',1)
                                 ->where('studentbookings.mid',$sesid)
                                  ->select('studentbookings.*','trainings.trainingname','students.sname','students.image')
                                  ->get();
        $result['cid']=$id;
       return view('manager.completed',$result);
    }
    public function postpass($id,$cid){
        $sesid=session()->get('MANAGER_ID');
        $model=studentbooking::find($id);
        $model->manpostapprove=$sesid;
        $model->save();
        return redirect('manager/completed/students/approved/'.$cid);
    }

    public function postapprove($id,$train){
        $sesid=session()->get('MANAGER_ID');
        $model=studentassignation::find($id);
        $model->cyclestatus=4;
        $model->save();

        DB::table('studentbookings') ->where('assignid', $id)->update( [ 'postapprove' => 1]); 
        return redirect('manager/completed/'.$train);
    }
    ...
    //      return 1;
     ...
     //  return $result;
        ...
        return view('manager.sectionrep',$result);
    }
 ...
 // return $request->post();
        ...
        return view('manager.detailedreport',$result);
   }
    ...
    public function swot($id){
        ...
        return view('manager.swot',$result);
    }
