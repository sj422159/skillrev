...
class reportcontroller extends Controller
{
     public function reports(){
      $sesid=session()->get('CLASSTEACHER_ID');
        ...
        $result['tri']=0;
        $result['data']=[];
        return view('classteacher.reports',$result);
    }
      public function assignmentreport($id){
        ...
        return view('classteacher.assignmentreportsection',$result);
    }
    ...
    //      return 1;
     ...
     //  return $result;
        ...
        return view('classteacher.sectionreport',$result);
    }
 ...
 // return $request->post();
        ...
        return view('classteacher.detailedreport',$result);
   }
   ...
   public function swot($id){
        ...
        return view('classteacher.swot',$result);
    }
}
