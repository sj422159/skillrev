...
class classteachercompetitionanalyticcontroller extends Controller
{
    
    public function index(){
        $supid=session()->get('CLASSTEACHER_SUP_ID');  
        ...
        $result['completed']=0;
        $result['data']=[];   
       return view('classteacher.competitionanalytic',$result); 
    }
