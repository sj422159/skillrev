...
class classteachertotalfeesanalyticcontroller extends Controller
{
    ...
    public function index(){
       ...
       return view('classteacher.pendingfeesanalytic',$result); 
    }
    ...
    public function fetch(request $request){
     ...
     public function currentindex(){
       ...
       return view('classteacher.currentfeesanalytic',$result); 
    }
