...
class supdetailcontroller extends Controller
{
     public function assreports(){
        ...
        if($group[0]->gtype==1){
            $result['class']=DB::table('categories')->where('groupid',$d[0]->groupid)->where('aid',$aid)->get();
        }else{
        ...
        $result['tri']=0;
        $result['data']=[];
        return view('supervisor.assignments',$result);
    }
    ...
    public function reports(){
        ...
        $result['section']=0;
        $result['data']=[];
        return view('supervisor.reports',$result);
    }
    ...
    public function fetchstu(request $request){
       $sesid=session()->get('SUPERVISOR_ID');
        ...
        $result['data']=DB::table('studentbookings')
                           ...
                           ->select('studentbookings.prereport','studentbookings.postreport','studentbookings.preapprove','students.sname','students.slname','trainings.trainingname','lmssections.section','students.image','studentbookings.studentassignmentid','studentbookings.id')
                           ->get();
    ...
    public function assignmentreport($id){
        ...
        return view('supervisor.assignmentreportsection',$result);
    }
    ...
    //      return 1;
     ...
     //  return $result;
        ...
        return view('supervisor.sectionreport',$result);
    }
 ...
 // return $request->post();
        ...
        return view('supervisor.detailedreport',$result);
   }
   ...
   public function swot($id){
        ...
        return view('supervisor.swot',$result);
    } 
}
