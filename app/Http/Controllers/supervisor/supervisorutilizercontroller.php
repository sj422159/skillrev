...
class supervisorutilizercontroller extends Controller
{
    public function ownschedule($id){
        ...
        $result['rowid']=0;
        $result['sec']="";
       return view('supervisor.ownscheduleform',$result);
    }
     ...
     public function getperiod(){
        ...
        $che=DB::table('periodtimetables')->where('tdayid',$day)->where('tportalid','GROUPMANAGER')->where('tprofileid',$id)->get();
        $checking=[];
    ...
    public function getsubject(){
        $day = $_GET['val'];
         ...
         $s=DB::table('supervisors')->where('id',$id)->get();
         $sub=explode("##",$s[0]->ssubjectid);
    ...
    public function schedulelist($stype,$id,$day=''){
     ...
     public function edit($id){
        ...
        $result['days']=["1"=>"Monday","2"=>"Tuesday","3"=>"Wednesday","4"=>"Thursday","5"=>"Friday","6"=>"Saturday"];
        $d=DB::table('supervisors')->where('id',$data[0]->tprofileid)->get();
        $sub=$d[0]->ssubjectid;
        $sub=explode("##",$sub);
        $result['name']=$d[0]->supname;
        $result['id']=$d[0]->id;
