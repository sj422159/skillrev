...
class Feesanalyticcontroller extends Controller
{
    ...
    public function index(){
       ...
       return view('controller.account.pendingfeesanalytic',$result); 
    }
    ...
    public function fetch(request $request){
     ...
     public function currentindex(){
       ...
       return view('controller.account.currentfeesanalytic',$result); 
    }
