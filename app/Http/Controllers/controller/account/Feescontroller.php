...
class Feescontroller extends Controller
{
    public function busroute(){
        ...
        $result['data']=DB::table('busroutes')->where('aid',$Controller_ADMIN_ID)->orwhere('Controller_ID',$Controller_ID)->get();
    ...
    public function savebusroute(request $request){
      $aid=session()->get('ControlleADMIN_ID');
    ...
    public function distance(){
        $Controller_ADMIN_ID=session()->get('Controller_ADMIN_ID');
        $Controller_ID=session()->get('Controller_ID');
        $result['busroutes']=DB::table('busroutes')->where('aid',$Controller_ADMIN_ID)->orwhere('Controller_ID',$Controller_ID)->where('status',1)->get();
        $result['data']=DB::table('distances')
                       ->join('busroutes','busroutes.id','distances.busrouteid')
                       ->where('distances.aid',$Controller_ADMIN_ID)->orwhere('distances.Controller_ID',$Controller_ID)
                       ->select('busroutes.busroute','distances.*')
                       ->get();
        return view('controller.account.distance',$result);
    }
    ...
    public function upload(Request $request){   
        ...
        if($validator->passes()){
            ...
            Excel::import(new distanceImport( $Controller_ADMIN_ID,$busrouteid,$Controller_ID),request()->file('excel')->store('temp'));
            $msg="File Uploaded Successfully";
            $request->session()->flash('success',$msg);
            return redirect('account/fees/distance'); 
        }else{
    ...
    public function adddistance(request $request,$id=""){
        ...
        return view('controller.account.adddistance',$result);
    }
    ...
    public function category(){
        ...
        return view('controller.account.feescategory',$result);
    }
    ...
    public function addcategory(request $request,$id=""){
        ...
        return view('controller.account.addfeescategory',$result);
    }
    ...
    public function savecategory(request $request){
     ...
     if($request->post('id')>0){
      ...
      $model->save();
      return redirect("account/fees/category");
    }
   ...
   //schedule
    ...
    public function schedule(){
        ...
        $result['otherdata']=DB::table('feeschedules')
                    ...
                    ->where('feeschedules.aid',$Controller_ADMIN_ID)
        ...
        $result['transportdata']=DB::table('feeschedules')
                    ...
                    ->select('feecategories.fcategory','feeschedules.*')
                    ->get();
        return view('controller.account.feeschedule',$result);
    }
    ...
    public function addschedule(request $request,$id=""){
        ...
        $result['categories']=DB::table('feecategories')->where('aid',$Controller_ADMIN_ID)->where('fctype',1)->where('fcstatus',1)->get();
        $result['class']=DB::table('categories')->where('aid',$Controller_ADMIN_ID)->get();
        $result['distance']=DB::table('distances')->where('aid',$Controller_ADMIN_ID)->where('disstatus',1)->get();       
        return view('controller.account.addfeeschedule',$result);
    }
    ...
    public function saveschedule(request $request){
     ...
     if($request->post('id')>0){
      ...
      $model->save();
      return redirect("account/fees/schedule");
    }
    ...
    public function transportschedule(){
        ...
        return view('controller.account.transportfeeschedule',$result);
    }
    ...
    public function addtransportschedule(request $request,$moneystatus,$busrouteid){
        ...
        return view('controller.account.addtransportfeeschedule',$result);
    }
    ...
    if($request->post('moneystatus')==1){
      ...
      $model->moneystatus=1;
      $model->save();
      return redirect("account/transport/fees/schedule/busroutes");
    }
    ...
    public function discount(){
        ...
        return view('controller.account.feesdiscount',$result);
    }
    ...
    public function adddiscount(request $request,$id=""){
        ...
        return view('controller.account.addfeesdiscount',$result);
    }
    ...
    public function savediscount(request $request){
     ...
     if($request->post('id')>0){
      ...
      $model->disname=$name;
      $model->save();
      return redirect("account/fees/discount");
    }
    ...
    public function pendingfeesstudents(){
        ...
        $result['class']=[];
        $result['section']=[];
        return view('controller.account.pendingfeesstudents',$result);
    }
    ...
    public function pendingfeesinitialsave(request $request){
        ...
        return redirect('account/fees/pending');
    }
    ...
    public function indexfeesstudents(){
        ...
        $result['section']=[];
        $result['paymentcount']=[];
        return view('controller.account.paidindex',$result);
    }
    ...
    public function feestransfer(request $request){
        ...
        return redirect("account/fees/index/students");
    }
    ...
    public function feesstructure(Request $request,$id){
        ...
        $result['data']=DB::table('feeselections')
                    ...
                    ->get();
        $result['sid']=$id;
        return view('controller.account.paidintsallment',$result);
    }
    ...
    public function currentyearpendingfeesstudents(){
        ...
        $result['section']=[];
        $result['month']=[];
        return view('controller.account.currentyearpendingfeesstudents',$result);
    }
