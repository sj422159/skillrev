...
class Examassesmentsection extends Controller
{
    ...
    public function index(Request $request,$id='')
    {
        ...
        return view('controller.exam.assesmentordering',$result);
   ...
   public function comodule(Request $request){
    ...
    return redirect('exam_controller/assesments');
   }
    ...
    public function delete(Request $request,$id){
       ...
       if ($model) {
         ...
         return redirect()->route('exam_cocreate', [
           'training' => $result['data'][0]->train,
           'atype' => $result['data'][0]->asstype,
           'assesmenttotaltime' => $result['data'][0]->time,
           'assesmentimage' => $result['data'][0]->img,
           'ttype' => $result['data'][0]->ttype,
           'training' => $result['data'][0]->train,
           'sdesc' => $result['data'][0]->sdes,
           'id' => $result['data'][0]->id,
