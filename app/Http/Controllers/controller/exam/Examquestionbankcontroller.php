...
class Examquestionbankcontroller extends Controller
{
    public function examview($id){
        ...
        return view('controller.exam.viewquestion',$result);
    }
    ...
    public function questions(Request $request) {
        ...
        $result['data']=[]; 
        return view('controller.exam.questions',$result);
    }
    ...
    public function add(){
        ...
        return view ('controller.exam.uploadquestion',$result);
    }
    ...
    public function upload(Request $request){   
        ...
        if($validator->passes()){
            ...
            return redirect('exam_controller/questions'); 
    ...
    public function editQuestion(Request $request,$id){
        ...
        return view('controller.exam.editquestion',$result);
     }
    ...
    public function mismatch(){
        ...
        return view('controller.exam.questionmismatch',$result);
    }
    public function improper(){
        $result['que']=DB::table('questionbanks')
                         ...
                         ->join('domains','skillattributes.domain','=','domains.id')
                         ->select('questionbanks.*','skillattributes.skillattribute','skillsets.skillset','domains.domain')->get();
        return view('controller.exam.improperquestion',$result);
    }    
